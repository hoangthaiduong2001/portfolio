        ...
        <div className="w-full lg:w-1/2 mt-4">
          <div className="flex justify-center">
            <motion.button
              ...
              animate="visible"
              type="button"
              className="flex items-center justify-center gap-1 tracking-tight text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2"
              onClick={handleDownload}
            >
              <FileText className="w-3 h-3 sm:w-4 sm:h-4" /> Download CV
            </motion.button>
          </div>
        </div>
      </div>
